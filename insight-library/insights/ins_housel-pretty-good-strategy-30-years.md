---
id: ins_housel-pretty-good-strategy-30-years
...
source_type: book
source_title: "The Psychology of Money — Sustainability over Brilliance"
source_date: 2020-09-08
captured_date: 2026-05-05
domain: [strategy, founder-craft, leadership]
lifecycle: [strategy-bets, career-arc]
maturity: foundational
artifact_class: framework
score: { originality: 5, specificity: 5, evidence: 5, transferability: 5, source: 5 }
tier: A
related: [ins_getting-vs-staying-wealthy, ins_career-sequence-leverage-then-judgment, ins_taleb-lindy-effect]
...
- Drawdowns are emotionally intolerable (you sell at the bottom).
...
## Conditions
Holds when:
- The decision-maker has control over duration (investing, GTM execution, product development, career path).
- The environment is stable enough that a 30-year strategy doesn't become obsolete (most personal-finance, many business strategies).
- The holder has the temperament to sustain through bad years.
...
- Career investments favour compounding skill domains (specific knowledge per Naval) over hot-trend short-term plays.
