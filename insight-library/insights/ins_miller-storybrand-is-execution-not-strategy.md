---
id: ins_miller-storybrand-is-execution-not-strategy
...
source_type: book
source_title: "Building a StoryBrand — Scope of the Framework"
...
tier: B
related: [ins_storybrand-customer-is-hero, ins_neumeier-onlyness-test, ins_brand-gap-five-disciplines]
...
## Cross-references
- `ins_storybrand-customer-is-hero`, `ins_miller-three-level-problem`, `ins_miller-guide-empathy-and-authority` — the StoryBrand stack.
- `ins_neumeier-onlyness-test` — the upstream test StoryBrand cannot substitute for.
- `ins_brand-gap-five-disciplines` — Neumeier's broader brand framework that StoryBrand fits inside.
