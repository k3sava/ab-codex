---
id: ins_b2b-buyer-emotion-personal-stakes
operator: Dave Gerhardt
operator_role: Founder, Exit Five; B2B marketing community + podcast
source_url: https://www.exitfive.com/podcast/real-talk-from-three-cmos-attribution-paid-media-and-why-b2b-is-more-emotional-than-you-think
source_type: podcast
source_title: "Exit Five Ep. 349 — Real talk from three CMOs"
source_date: 2026-04-23
captured_date: 2026-05-06
domain: [pmm, gtm, sales, marketing]
lifecycle: [positioning, messaging-frameworks, brand-strategy]
maturity: applied
artifact_class: framework
score: { originality: 4, specificity: 5, evidence: 4, transferability: 5, source: 4 }
tier: A
related: [ins_b2b-movement-not-campaigns, ins_gerhardt-founder-story-as-weapon, ins_gerhardt-brand-reputation-compounds]
raw_ref: 
---
...
## Cross-references
- `ins_gerhardt-founder-story-as-weapon` — same operator's framing of how to actually deliver the emotional layer credibly.
- `ins_gerhardt-brand-reputation-compounds` — the long-arc consequence: brands that read survival math correctly accumulate the reputation premium that survives switching cycles.
- `ins_scarcity-supercycle` — McCormick's framing of why the human-relationship element commands the premium.
