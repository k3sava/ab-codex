---
id: ins_gerhardt-community-as-distribution-moat
...
source_type: book
source_title: "Founder Brand — Community as Moat"
source_date: 2022-09-15
captured_date: 2026-05-05
domain: [pmm, growth-demand, founder-craft]
lifecycle: [community-building, content-strategy, demand-gen]
maturity: applied
artifact_class: framework
score: { originality: 4, specificity: 4, evidence: 4, transferability: 4, source: 5 }
tier: A
related: [ins_gerhardt-founder-story-as-weapon, ins_gerhardt-distribution-beats-creation, ins_smallest-viable-audience]
...
## Cross-references
- `ins_gerhardt-founder-story-as-weapon` — the founder is the convenor of the community.
- `ins_gerhardt-distribution-beats-creation` — the community is the distribution channel.
- `ins_smallest-viable-audience` — Godin's adjacent claim; the smallest viable audience is the community kernel.
