---
id: ins_rackham-investigation-stage-creates-stars
operator: Neil Rackham
operator_role: Founder Huthwaite International; author SPIN Selling, Major Account Sales Strategy
source_url: https://www.spinselling.com/
source_type: book
source_title: "SPIN Selling — Where Star Performance Lives"
source_date: 1988-05-01
captured_date: 2026-05-05
domain: [sales-cs, research-discovery, leadership]
...
tier: A
related: [ins_spin-implication-questions, ins_rackham-objections-symptom-of-poor-presentation, ins_coachability-beats-experience, ins_voss-mirroring-forces-elaboration]
...
## Cross-references
- `ins_spin-implication-questions` — the highest-leverage question type within the investigation stage.
- `ins_rackham-objections-symptom-of-poor-presentation` — the corollary: investigation-stage need-development prevents objections later.
- `ins_coachability-beats-experience` — Roberge's hiring claim aligns: question-asking discipline is more coachable than charisma.
- `ins_voss-mirroring-forces-elaboration` — Voss's mechanism for surfacing buyer information complements SPIN's question typology.
