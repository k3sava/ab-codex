...
source_type: book
source_title: "Never Split the Difference — Accusation Audit"
source_date: 2016-05-17
captured_date: 2026-05-05
domain: [sales-cs, leadership, pmm]
lifecycle: [sales-enablement, discovery-conversations, deal-strategy]
maturity: applied
artifact_class: framework
score: { originality: 4, specificity: 5, evidence: 4, transferability: 5, source: 5 }
tier: A
related: [ins_voss-mirroring-forces-elaboration, ins_calibrated-questions-illusion-of-control]
...
## Cross-references
- `ins_voss-mirroring-forces-elaboration` — accusation audit is the opener that clears emotional debris; mirrors collect information once the channel is clear.
- `ins_calibrated-questions-illusion-of-control` — once accusations are audited, calibrated questions move the counterpart from defensive to cooperative.
