---
id: ins_voss-black-swans-discovered-in-process
operator: Chris Voss
...
source_type: book
source_title: "Never Split the Difference — Black Swans"
source_date: 2016-05-17
captured_date: 2026-05-05
domain: [strategy, sales-cs, research-discovery]
lifecycle: [deal-strategy, discovery-conversations, customer-research]
maturity: applied
...
## Cross-references
- `ins_voss-mirroring-forces-elaboration`, `ins_voss-accusation-audit`, `ins_voss-thats-right-breakthrough` — the three tools that produce the rapport conditions where Black Swans surface.
- `ins_jtbd-interviews-surface-customer-language` — Moesta's switch interviews are the customer-research equivalent of Black Swan discovery.
