---
id: ins_handley-write-what-you-want-to-read
...
source_type: essay
source_title: "Total Annarchy — Write What You Want To Read"
source_date: 2024-04-01
captured_date: 2026-05-05
domain: [pmm, marketing, growth-demand]
lifecycle: [content-strategy, voice-development, audience-building]
maturity: applied
artifact_class: framework
score: { originality: 4, specificity: 4, evidence: 4, transferability: 4, source: 5 }
tier: A
related: [ins_handley-voice-as-moat-against-ai, ins_so-what-as-content-diagnostic, ins_smallest-viable-audience]
...
## Cross-references
- `ins_handley-voice-as-moat-against-ai` — voice is what self-oriented writing produces; this card is the discipline that develops voice.
- `ins_so-what-as-content-diagnostic` — Handley's foundational claim; "so what?" is the test that catches self-indulgence.
- `ins_smallest-viable-audience` — Godin's adjacent claim; the smallest viable audience is the segment that matches the creator's taste.
