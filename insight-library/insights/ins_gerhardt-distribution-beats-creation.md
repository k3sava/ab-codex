---
id: ins_gerhardt-distribution-beats-creation
...
source_type: book
source_title: "Founder Brand — Distribution Beats Creation"
source_date: 2022-09-15
captured_date: 2026-05-05
domain: [pmm, growth-demand, gtm]
lifecycle: [content-strategy, distribution]
maturity: applied
artifact_class: framework
score: { originality: 4, specificity: 5, evidence: 4, transferability: 5, source: 5 }
tier: A
related: [ins_gerhardt-social-as-testing-lab, ins_thiel-poor-sales-not-bad-product, ins_godin-five-step-marketing-process]
...
## Cross-references
- `ins_gerhardt-social-as-testing-lab` — the validation method that pairs with this distribution-led mindset.
- `ins_thiel-poor-sales-not-bad-product` — Thiel's adjacent claim that distribution failure beats product failure as a cause of company death.
- `ins_godin-five-step-marketing-process` — Godin's claim that "spread the word" is step 4, not step 1; distribution requires the prior steps.
