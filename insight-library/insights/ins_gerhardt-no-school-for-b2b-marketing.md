---
id: ins_gerhardt-no-school-for-b2b-marketing
operator: Dave Gerhardt
operator_role: Founder Exit Five (B2B Marketing community); former CMO Privy and Drift; author Founder Brand
source_url: https://www.exitfive.com/
source_type: essay
source_title: "Exit Five — Why B2B Marketing Has a Creativity Deficit"
source_date: 2024-03-01
captured_date: 2026-05-05
domain: [pmm, growth-demand, strategy]
lifecycle: [content-strategy, brand-strategy, hiring-team-design]
maturity: applied
artifact_class: framework
score: { originality: 4, specificity: 4, evidence: 3, transferability: 4, source: 5 }
tier: A
related: [ins_b2b-movement-not-campaigns, ins_gerhardt-brand-reputation-compounds]
...
## Cross-references
- `ins_b2b-movement-not-campaigns` — the canonical Gerhardt card; building a movement requires the creative capability this card identifies as missing.
- `ins_gerhardt-brand-reputation-compounds` — the economic argument for investing in the deficit.
