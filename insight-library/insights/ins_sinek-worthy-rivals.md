...
source_type: book
source_title: "The Infinite Game — Worthy Rivals"
source_date: 2019-10-15
captured_date: 2026-05-05
domain: [strategy, leadership, founder-craft]
lifecycle: [strategy-bets, competitive-analysis, learning-development]
maturity: applied
artifact_class: framework
score: { originality: 4, specificity: 4, evidence: 3, transferability: 4, source: 5 }
tier: B
related: [ins_sinek-infinite-game, ins_circle-of-competence, ins_thiel-competition-destroys-profits]
...
## Cross-references
- `ins_sinek-infinite-game` — the parent frame.
- `ins_circle-of-competence` — Munger's circle defines the operator's edge; worthy rivals reveal where the circle should expand.
- `ins_thiel-competition-destroys-profits` — Thiel's adjacent claim that competitive markets erode profits; Sinek's worthy-rival framing is the constructive use of competition once you've accepted you can't escape it.
