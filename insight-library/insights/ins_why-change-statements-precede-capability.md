---
id: ins_why-change-statements-precede-capability
operator: Gartner
operator_role: Charlie Xu, John Quaglietta, Jennifer MacIntosh, Gartner Research
source_url: https://www.gartner.com/en/documents/G00808124
source_type: research
source_title: 3 Pillars to Ramp Up User Adoption and Unlock Customer Value
source_date: 2024-06-24
captured_date: 2026-05-02
domain: [pmm, gtm, customer-success]
lifecycle: [onboarding-activation, retention, messaging-narrative]
maturity: foundational
artifact_class: playbook
score: { originality: 3, specificity: 4, evidence: 5, transferability: 5, source: 5 }
tier: B
related: [ins_test-positioning-in-live-sales-pitch]
...
## Conditions
Holds when:
- The user has at least some agency in adopting (not pure mandate).
