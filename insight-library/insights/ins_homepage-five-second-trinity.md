---
id: ins_homepage-five-second-trinity
operator: Anthony Pierri
operator_role: Co-founder, Fletch PMM
...
tier: B
related: [ins_setup-follow-through-pitch, ins_no-decision-is-the-real-competitor, ins_pmm-as-infrastructure-not-gate]
raw_ref: raw/essays/anthony-pierri--7-step-homepage--2026-04.md
---
...
## Cross-references
- `ins_setup-follow-through-pitch` — Dunford's pitch architecture maps to the same trinity.
- `ins_no-decision-is-the-real-competitor` — the alternative is often status quo, not a competitor.
- `ins_pmm-as-infrastructure-not-gate` — Verna's structure for how PMM scales this work across surfaces.
