---
id: ins_miller-one-liner-formula
...
source_type: book
source_title: "Building a StoryBrand — The One-Liner"
source_date: 2017-10-10
captured_date: 2026-05-05
domain: [pmm, marketing, sales-cs]
lifecycle: [messaging-narrative, copy-and-content, sales-enablement]
maturity: applied
...
## Cross-references
- `ins_storybrand-customer-is-hero`, `ins_miller-three-level-problem` — the One-Liner is the compressed version of the StoryBrand seven-part framework.
- `ins_homepage-five-second-trinity` — Pierri's homepage equivalent (use case, alternative, result).
