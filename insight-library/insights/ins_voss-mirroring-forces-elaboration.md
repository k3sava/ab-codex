---
id: ins_voss-mirroring-forces-elaboration
operator: Chris Voss
...
source_type: book
source_title: "Never Split the Difference — Mirroring"
source_date: 2016-05-17
captured_date: 2026-05-05
domain: [sales-cs, research-discovery, pmm]
...
tier: A
related: [ins_calibrated-questions-illusion-of-control, ins_no-oriented-questions]
...
## Cross-references
- `ins_calibrated-questions-illusion-of-control` — calibrated questions invite cooperative problem-solving; mirrors gather the information that makes the calibrated question land.
- `ins_no-oriented-questions` — Voss's three-tool stack: mirrors + tactical empathy + no-oriented framing.
- `ins_jtbd-interviews-surface-customer-language` — Moesta's switch interviews use the same mechanism: silence and elaboration surface verbatim buyer language.
