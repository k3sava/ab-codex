---
id: ins_company-story-is-the-strategy
operator: Andy Raskin
operator_role: Strategic narrative consultant; Andy Raskin & Co
source_url: https://andyraskin.com/
source_type: essay
source_title: April update — story-is-strategy
source_date: 2026-04
captured_date: 2026-05-01
domain: [pmm, strategy]
lifecycle: [positioning, narrative]
maturity: foundational
artifact_class: framework
score: { originality: 3, specificity: 3, evidence: 3, transferability: 5, source: 4 }
tier: B
related: [ins_old-game-to-new-game-narrative, ins_setup-follow-through-pitch, ins_homepage-five-second-trinity]
raw_ref: raw/essays/andy-raskin--story-is-strategy--2026-04.md
---
...
## Cross-references
- `ins_old-game-to-new-game-narrative` — Raskin's canonical narrative architecture this audit protects.
- `ins_setup-follow-through-pitch` — Dunford's pitch structure that depends on a stable story.
- `ins_homepage-five-second-trinity` — Pierri's homepage frame; the audit checks whether it matches the deck.
