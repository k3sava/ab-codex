---
id: ins_voss-thats-right-breakthrough
operator: Chris Voss
...
source_type: book
source_title: "Never Split the Difference — That's Right"
source_date: 2016-05-17
captured_date: 2026-05-05
domain: [sales-cs, research-discovery, pmm]
lifecycle: [discovery-conversations, sales-enablement]
maturity: applied
artifact_class: framework
score: { originality: 4, specificity: 4, evidence: 4, transferability: 4, source: 5 }
tier: A
related: [ins_voss-mirroring-forces-elaboration, ins_voss-accusation-audit]
...
## Cross-references
- `ins_voss-mirroring-forces-elaboration` — mirrors gather the information; "that's right" confirms the summary built from it.
- `ins_voss-accusation-audit` — accusation audits clear the emotional debris that would prevent a "that's right" later.
