---
id: ins_schafer-pain-pleasure-polarity
operator: Cole Schafer
operator_role: Founder Honey Copy; copywriter for premium consumer brands; daily-newsletter writer
source_url: https://honeycopy.com/
source_type: essay
source_title: "Sticky Notes — Pain-Pleasure Polarity"
source_date: 2024-01-15
captured_date: 2026-05-05
domain: [pmm, marketing, growth-demand]
lifecycle: [copy-and-content, messaging-narrative, conversion-design]
maturity: applied
artifact_class: framework
score: { originality: 4, specificity: 5, evidence: 4, transferability: 5, source: 5 }
tier: A
related: [ins_20-percent-rule-headline, ins_loss-aversion-status-quo-bias, ins_miller-survival-value-messaging]
...
## Conditions
Holds when:
- The reader has discretion to engage or not (most marketing copy contexts).
- The product credibly delivers on the pleasure or pain-relief promised.
- The writer can identify which pole the target buyer is actually on (varies by buyer state).
...
- A/B tests of pain-led vs. pleasure-led versions reveal which pole the segment responds to (often surprising).
- Headlines pass the pole-test before any further refinement.
