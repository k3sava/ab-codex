---
id: ins_shleyner-conciseness-as-respect
...
source_type: essay
source_title: "VeryGoodCopy — Conciseness as Respect"
source_date: 2024-02-01
captured_date: 2026-05-05
domain: [pmm, design, marketing]
lifecycle: [copy-and-content, editing-discipline]
maturity: applied
artifact_class: framework
score: { originality: 3, specificity: 4, evidence: 3, transferability: 5, source: 5 }
tier: B
related: [ins_shleyner-clarity-beats-cleverness, ins_taleb-via-negativa]
...
## Cross-references
- `ins_shleyner-clarity-beats-cleverness` — Shleyner's adjacent claim; clarity and conciseness are reinforcing disciplines.
- `ins_taleb-via-negativa` — Taleb's broader principle that subtraction is more reliable than addition.
