---
id: ins_test-positioning-in-live-sales-pitch
operator: April Dunford
operator_role: Positioning consultant; author "Obviously Awesome" and "Sales Pitch"
source_url: https://aprildunford.substack.com/p/sales-first-storytelling
source_type: essay
source_title: Sales-First Storytelling
...
tier: B
related: [ins_setup-follow-through-pitch, ins_no-decision-is-the-real-competitor, ins_market-to-product-product-to-market]
...
## Cross-references
- `ins_setup-follow-through-pitch` — Dunford's structural frame for the pitch itself.
- `ins_no-decision-is-the-real-competitor` — Dunford on the real competitor; positioning has to beat status quo.
- `ins_market-to-product-product-to-market` — Lauchengco on PMM's two-way loop; this is the pressure-test of the outbound half.
