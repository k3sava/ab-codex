---
id: ins_ariely-arbitrary-coherence
operator: Dan Ariely
...
source_type: book
source_title: "Predictably Irrational — Arbitrary Coherence"
source_date: 2008-02-19
captured_date: 2026-05-05
domain: [pmm, growth-demand, strategy]
lifecycle: [pricing-packaging, category-creation, brand-strategy]
maturity: foundational
artifact_class: framework
score: { originality: 5, specificity: 5, evidence: 5, transferability: 5, source: 5 }
tier: A
related: [ins_anchoring-pricing-negotiation, ins_ariely-relativity-principle, ins_simon-discounting-most-dangerous-practice]
...
## Counter-evidence
Some categories see anchor-resets driven by technology disruption (cloud computing pricing vs. on-prem, AI-substitution pricing vs. SaaS) where the original anchor genuinely no longer applies. Ramanujam's `ins_ramanujam-ai-pricing-against-labor-budgets` is the explicit re-anchoring move for AI products.

## Cross-references
- `ins_anchoring-pricing-negotiation` — Kahneman's per-transaction anchoring; Arbitrary Coherence is the category-persistent version.
- `ins_ariely-relativity-principle` — relativity is the comparison mechanism that makes Arbitrary Coherence load-bearing.
- `ins_simon-discounting-most-dangerous-practice` — discounting damages Arbitrary Coherence by training the buyer that the original anchor was arbitrary.
