---
id: ins_sinek-existential-flexibility
...
source_type: book
source_title: "The Infinite Game — Existential Flexibility"
source_date: 2019-10-15
captured_date: 2026-05-05
domain: [strategy, founder-craft, leadership]
lifecycle: [strategy-bets, pivot-decisions]
maturity: applied
artifact_class: framework
score: { originality: 4, specificity: 4, evidence: 4, transferability: 4, source: 5 }
tier: B
related: [ins_sinek-just-cause, ins_thiel-vertical-vs-horizontal-progress, ins_ramanujam-hidden-gems]
...
## Cross-references
- `ins_sinek-just-cause` — the orientation that existential flexibility serves.
- `ins_thiel-vertical-vs-horizontal-progress` — Thiel's adjacent claim; existential flexibility is one form of investing in 0-to-1 vertical progress when the current 1-to-n optimisation is still profitable.
- `ins_ramanujam-hidden-gems` — the failure mode that existential flexibility prevents.
