...
tier: B
related: [ins_market-to-product-product-to-market]
...
## Cross-references
- `ins_market-to-product-product-to-market` — Lauchengco frame; pricing is the inbound→outbound feedback loop in compressed form.
