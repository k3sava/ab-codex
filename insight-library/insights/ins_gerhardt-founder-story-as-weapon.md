---
id: ins_gerhardt-founder-story-as-weapon
operator: Dave Gerhardt
operator_role: Founder Exit Five; former CMO Privy and Drift; author Founder Brand
source_url: https://www.exitfive.com/
source_type: book
source_title: "Founder Brand — The Founder Story Tactic"
source_date: 2022-09-15
captured_date: 2026-05-05
domain: [pmm, founder-craft, growth-demand]
lifecycle: [brand-strategy, content-strategy, founder-led-marketing]
maturity: applied
artifact_class: playbook
score: { originality: 4, specificity: 5, evidence: 4, transferability: 4, source: 5 }
tier: A
related: [ins_b2b-movement-not-campaigns, ins_gerhardt-brand-reputation-compounds, ins_neumeier-customers-join-not-buy]
...
## Cross-references
- `ins_b2b-movement-not-campaigns` — the canonical Gerhardt card; the founder is often the centre of the movement.
- `ins_gerhardt-brand-reputation-compounds` — the founder story is a high-leverage way to build the compounding reputation asset.
- `ins_neumeier-customers-join-not-buy` — Neumeier's adjacent claim; customers join brands they identify with, often through the founder.
