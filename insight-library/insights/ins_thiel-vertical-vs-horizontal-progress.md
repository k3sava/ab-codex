---
id: ins_thiel-vertical-vs-horizontal-progress
...
## Cross-references
- `ins_zero-to-one-monopoly` — the natural endpoint of vertical progress is monopoly; competition only happens once 1-to-n imitators arrive.
- `ins_thiel-power-law` — the power law explains why 0-to-1 bets are worth disproportionate effort: the few that work return more than all 1-to-n work combined.
