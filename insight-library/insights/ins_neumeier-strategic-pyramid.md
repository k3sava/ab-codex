---
id: ins_neumeier-strategic-pyramid
...
source_type: book
source_title: "Scramble — Strategic Pyramid"
...
tier: B
related: [ins_neumeier-agile-strategy-five-ps, ins_neumeier-onlyness-test]
...
## Cross-references
- `ins_neumeier-onlyness-test` — Onlyness sits in the middle layer (between Purpose and tactics) and connects the two.
- `ins_neumeier-agile-strategy-five-ps` — Agile Strategy iterates within the pyramid; the pyramid bounds which iterations are at which layer.
