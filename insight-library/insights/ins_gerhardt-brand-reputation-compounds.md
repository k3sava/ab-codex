---
id: ins_gerhardt-brand-reputation-compounds
...
source_type: book
source_title: "Founder Brand — Brand as Compounding Asset"
source_date: 2022-09-15
captured_date: 2026-05-05
domain: [growth-demand, strategy, pmm]
lifecycle: [brand-strategy, distribution, demand-gen]
maturity: applied
artifact_class: framework
score: { originality: 4, specificity: 4, evidence: 4, transferability: 5, source: 5 }
tier: A
related: [ins_b2b-movement-not-campaigns, ins_gerhardt-no-school-for-b2b-marketing, ins_skok-ltv-cac-as-cross-functional-diagnostic]
...
## Cross-references
- `ins_b2b-movement-not-campaigns` — the canonical Gerhardt card; a movement is one mechanism for compounding reputation.
- `ins_gerhardt-no-school-for-b2b-marketing` — the structural reason most B2B teams underinvest in brand.
- `ins_skok-ltv-cac-as-cross-functional-diagnostic` — Skok's adjacent claim; declining LTV:CAC requires diagnosis across product, sales, and brand.
