---
id: ins_harland-benefits-over-pride
...
source_type: essay
source_title: "The Copy Cabin — Benefits Over Pride"
source_date: 2024-03-01
captured_date: 2026-05-05
domain: [pmm, marketing, sales-cs]
lifecycle: [copy-and-content, messaging-narrative]
maturity: applied
artifact_class: framework
score: { originality: 3, specificity: 5, evidence: 3, transferability: 5, source: 5 }
tier: A
related: [ins_write-like-you-speak, ins_storybrand-customer-is-hero, ins_miller-survival-value-messaging]
...
## Cross-references
- `ins_write-like-you-speak` — Harland's foundational claim; the operational way to be reader-centred is to write conversationally.
- `ins_storybrand-customer-is-hero` — Miller's adjacent claim; the customer is the hero, the brand is the guide.
