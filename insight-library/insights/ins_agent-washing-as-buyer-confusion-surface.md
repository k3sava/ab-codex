---
id: ins_agent-washing-as-buyer-confusion-surface
operator: Gartner
...
lifecycle: [positioning, messaging-narrative, strategy-bets]
maturity: applied
artifact_class: framework
score: { originality: 4, specificity: 3, evidence: 4, transferability: 5, source: 5 }
tier: B
related: [ins_semi-autonomous-is-the-enterprise-baseline, ins_no-decision-is-the-real-competitor]
...
## Cross-references
- `ins_semi-autonomous-is-the-enterprise-baseline` — Gartner companion frame on what real agents look like.
- `ins_no-decision-is-the-real-competitor` — Dunford on what positioning has to actually overcome.
