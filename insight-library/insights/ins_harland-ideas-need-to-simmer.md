---
id: ins_harland-ideas-need-to-simmer
...
source_type: essay
source_title: "The Copy Cabin — Ideas Need to Simmer"
source_date: 2024-03-01
captured_date: 2026-05-05
domain: [founder-craft, marketing, design]
lifecycle: [writing-process, decision-quality]
maturity: applied
artifact_class: framework
score: { originality: 3, specificity: 4, evidence: 3, transferability: 4, source: 5 }
tier: B
related: [ins_harland-scream-principle, ins_planning-fallacy-launch-timelines]
raw_ref: raw/expert-content/experts/dave-harland.md
---

# Ideas need to simmer — walking away from a draft and returning later is necessary for critical editing, not optional
...
## Cross-references
- `ins_harland-scream-principle` — Harland's adjacent claim; the scream often emerges only after the simmer.
- `ins_planning-fallacy-launch-timelines` — Kahneman's claim that the inside view is systematically optimistic; the simmer is the structural fix that lets the outside view emerge.
