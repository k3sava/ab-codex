---
id: ins_handley-white-space-as-oxygen
...
source_type: essay
source_title: "Total Annarchy — White Space as Oxygen"
source_date: 2024-04-01
captured_date: 2026-05-05
domain: [pmm, design, marketing]
lifecycle: [content-strategy, formatting, readability-design]
maturity: applied
artifact_class: framework
score: { originality: 3, specificity: 4, evidence: 3, transferability: 5, source: 5 }
tier: B
related: [ins_handley-write-to-one-subscriber, ins_shleyner-conciseness-as-respect]
...
## Cross-references
- `ins_handley-write-to-one-subscriber` — direct-address writing pairs with white-space formatting; both reduce the felt distance between writer and reader.
- `ins_shleyner-conciseness-as-respect` — Shleyner's adjacent claim; conciseness and white space both signal respect for reader time.
