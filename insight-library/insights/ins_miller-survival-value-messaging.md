---
id: ins_miller-survival-value-messaging
...
source_type: book
source_title: "Building a StoryBrand — Survival-Value Filter"
source_date: 2017-10-10
captured_date: 2026-05-05
domain: [pmm, marketing, design]
lifecycle: [messaging-narrative, copy-and-content, homepage-design]
maturity: applied
artifact_class: framework
score: { originality: 3, specificity: 4, evidence: 3, transferability: 5, source: 5 }
tier: A
related: [ins_storybrand-customer-is-hero, ins_miller-caveman-test]
...
## Cross-references
- `ins_storybrand-customer-is-hero`, `ins_miller-caveman-test` — the StoryBrand stack: survival framing + customer-as-hero + caveman comprehensibility.
- `ins_worldview-led-marketing` — Godin's worldview is the differentiator on top of survival framing.
