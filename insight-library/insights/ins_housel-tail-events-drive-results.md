---
id: ins_housel-tail-events-drive-results
...
source_type: book
source_title: "The Psychology of Money — Tails Drive Everything"
source_date: 2020-09-08
captured_date: 2026-05-05
domain: [strategy, founder-craft, leadership]
lifecycle: [strategy-bets, portfolio-allocation]
maturity: foundational
artifact_class: framework
score: { originality: 4, specificity: 5, evidence: 5, transferability: 5, source: 5 }
tier: A
related: [ins_thiel-power-law, ins_taleb-barbell-strategy, ins_housel-pretty-good-strategy-30-years]
...
## Cross-references
- `ins_thiel-power-law` — Thiel's adjacent claim with concentration prescription; Housel's frame focuses on the failure-rate implication.
- `ins_taleb-barbell-strategy` — Taleb's adjacent claim; barbell allocation is the structural way to capture tails while protecting the safe end.
- `ins_housel-pretty-good-strategy-30-years` — the duration-and-survival corollary that lets you stay in the game long enough for tails to appear.
- `con_concentrate-vs-barbell-allocation` — the existing contradiction; Housel's framing leans toward Taleb's spread-many-bets stance.
