---
id: ins_housel-doing-nothing-during-crisis
...
source_type: book
source_title: "The Psychology of Money — The Inaction Premium"
source_date: 2020-09-08
captured_date: 2026-05-05
domain: [leadership, strategy, founder-craft]
lifecycle: [risk-quality, crisis-management, decision-quality]
maturity: applied
artifact_class: framework
score: { originality: 4, specificity: 4, evidence: 4, transferability: 4, source: 5 }
tier: A
related: [ins_taleb-iatrogenics, ins_planning-fallacy-launch-timelines, ins_voss-tactical-empathy-labels]
...
## Cross-references
- `ins_taleb-iatrogenics` — Taleb's claim that intervention causes more harm than the disease in complex systems; same principle, different vocabulary.
- `ins_planning-fallacy-launch-timelines` — Kahneman's claim that timelines are systematically optimistic; under crisis pressure, that optimism extends to "we can fix this in a week" intervention plans that compound the damage.
- `ins_voss-tactical-empathy-labels` — Voss's discipline of labeling emotion before reacting; the personal-decision-making analogue of Housel's strategic-decision-making claim.
