---
id: ins_rackham-implication-questions-4x-leverage
...
source_type: book
source_title: "SPIN Selling — Implication Questions"
source_date: 1988-05-01
captured_date: 2026-05-05
domain: [sales-cs, research-discovery]
lifecycle: [discovery-conversations, sales-enablement, sales-training]
maturity: foundational
artifact_class: framework
score: { originality: 5, specificity: 5, evidence: 5, transferability: 5, source: 5 }
tier: A
related: [ins_spin-implication-questions, ins_rackham-investigation-stage-creates-stars, ins_voss-mirroring-forces-elaboration]
...
## Cross-references
- `ins_spin-implication-questions` — the canonical Rackham card; this card details the 4× leverage finding.
- `ins_rackham-investigation-stage-creates-stars` — the broader claim that investigation-stage question-asking is what differentiates stars.
- `ins_voss-mirroring-forces-elaboration` — Voss's mechanism for surfacing the answers that Implication questions probe for.
