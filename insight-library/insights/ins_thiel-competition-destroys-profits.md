---
id: ins_thiel-competition-destroys-profits
...
source_type: book
source_title: "Zero to One — Competition is for Losers"
source_date: 2014-09-16
captured_date: 2026-05-05
domain: [strategy, growth-demand, pmm]
lifecycle: [strategy-bets, positioning, market-selection]
maturity: foundational
artifact_class: framework
score: { originality: 4, specificity: 5, evidence: 5, transferability: 5, source: 5 }
tier: A
related: [ins_zero-to-one-monopoly, ins_thiel-vertical-vs-horizontal-progress]
...
## Cross-references
- `ins_zero-to-one-monopoly` — building monopoly is the proactive answer to the competitive-market problem.
- `ins_thiel-vertical-vs-horizontal-progress` — vertical progress (0-to-1) creates the monopoly conditions; horizontal progress (1-to-n) walks into competitive markets.
- `ins_starving-crowd-beats-offer` — Hormozi's market hierarchy applies the same insight at the operational level.
