...
slug: addy-osmani
roles:
  - Engineering lead at Google Chrome
  - Long-running writer on web platform performance and developer experience
  - Author of multiple books on JavaScript and frontend engineering
domains_active: [ai-native, engineering, design, growth]
...
## Cards
- `ins_agentic-engine-optimization-6-layer` — Six-layer agent-first content audit: access, discovery, capability, format, token, UX bridge [Tier A]
