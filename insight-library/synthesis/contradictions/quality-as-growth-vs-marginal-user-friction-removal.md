---
id: con_quality-vs-marginal-user-friction
title: Quality/friction-as-feature vs. marginal-user friction removal
captured_date: 2026-05-01
---

# Quality/friction-as-feature vs. marginal-user friction removal

## Position A — Friction qualifies users, brand and quality are growth
- Operator: Amole Naik (`ins_friction-as-feature`, `ins_quality-as-growth-lever`), Amol Avasare (`ins_right-friction-beats-no-friction`)
...
- Operator: Adriel Frederick (`ins_marginal-user-methodology`)
