---
id: con_no-decision-vs-named-competitor
title: No-decision-as-competitor vs. battle-card-driven competitive workflows
captured_date: 2026-05-01
---

# No-decision-as-competitor vs. battle-card-driven competitive workflows

## Position A — The real competitor is no-decision
- Operator: April Dunford (`ins_no-decision-is-the-real-competitor`, `ins_setup-follow-through-pitch`), Jessica Fain (implicit), Anthony Pierri (`ins_homepage-five-second-trinity`)
...
- Operator: Gartner (`ins_battle-cards-as-workflow-primitive`, `ins_sameness-perception-is-the-differentiation-barrier`), Maja Voje (`ins_claude-plus-crm-plus-orchestration-stack`)
