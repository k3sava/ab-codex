---
id: con_post-training-moat-vs-distribution-moat
title: Post-training data as moat vs. distribution/ecosystem as moat
...
- Card: `ins_post-training-as-the-moat`
...
- Operator: Evan Spiegel (`ins_software-is-not-a-moat`), Brian Balfour (`ins_distribution-platform-cycles`), Elena Verna (`ins_earned-channels-over-algorithm-channels`)
...
- **Time horizon**: Post-training moat is real this cycle but exposed to commoditize-the-complement pressure (Tunguz, `ins_commoditize-the-complement-ai`). Distribution moats compound for decades.
