---
id: pat_llm-as-os
title: LLM-as-OS, post-training as moat
captured_date: 2026-05-01
convergence_count: 4
tier: A
uses_cards: [ins_llms-are-new-os-agents-are-apps, ins_post-training-as-the-moat, ins_software-is-not-a-moat, ins_intelligence-into-things-that-already-exist, ins_commoditize-the-complement-ai, ins_capability-overhang-product-problem]
domains: [ai-native, product, strategy-bets]
---
...
## Operators
- Mark Petty (Gartner) — `ins_llms-are-new-os-agents-are-apps`. LLM platform is the new OS; agents are the new apps; MCP registries are the new app stores.
- Asha Sharma (Microsoft AI) — `ins_post-training-as-the-moat` and `ins_product-as-organism`. The economic moat is post-training on proprietary data, not pre-training; product is a living organism with metabolism.
- Evan Spiegel — `ins_software-is-not-a-moat`. Software is not a moat — ecosystems, hardware, distribution are.
- Qasar Younis — `ins_intelligence-into-things-that-already-exist`. Position AI as intelligence into existing things, not as a new thing.
- Tomasz Tunguz — `ins_commoditize-the-complement-ai`. Foundation labs run the commoditize-the-complement playbook; tag features as core or complement quarterly.
- Amole Naik — `ins_capability-overhang-product-problem`. In AI products, the central growth problem is capability overhang — distribution + data integration close the gap.
