---
id: pat_principal-ic-as-force-multiplier
title: Principal/staff IC as force-multiplier archetype
captured_date: 2026-05-01
convergence_count: 4
tier: A
uses_cards: [ins_principal-ic-is-force-multiplier, ins_staff-archetypes-rotate-by-design, ins_glue-work-is-staff-leadership, ins_all-problems-become-people-problems, ins_engineers-with-product-taste]
domains: [hiring-team-design, leadership, engineering]
---
...
## Operators
- Silvia Botros — `ins_principal-ic-is-force-multiplier` and `ins_all-problems-become-people-problems`. Principal IC is a force multiplier; above a certain level every problem is a people problem.
- Will Larson — `ins_staff-archetypes-rotate-by-design`. Four staff-engineer archetypes; two of them rotate across teams by design.
- Tanya Reilly — `ins_glue-work-is-staff-leadership`. Glue work IS technical leadership, not a tax on the IC.
- Cat Wu — `ins_engineers-with-product-taste`. The hiring expression: hire engineers with product taste rather than adding more PMs.
