...
uses_cards: [ins_homepage-five-second-trinity, ins_pain-solution-proof-interleaved-pitch]
originating_operators: [eli-schwartz]
secondary_sources:
  - team-brain/workflows/copywriting-mastery.md
  - flywheel/skills/copywrite/SKILL.md
...
- **Hero:** Pierri's 4-question test. Answer "what is it / who is it for / what does it replace / why is it better" inside 5 seconds (`ins_homepage-five-second-trinity`).
- **Feature sections:** 3W formula — What it is, Why the benefit matters, So what the outcome is.
- **Social proof:** Interleave after every 2nd or 3rd benefit claim. Specific metric + named person + named company. Never segregate to a "testimonial section" only (`ins_pain-solution-proof-interleaved-pitch`).
