...
uses_cards: [ins_battle-cards-as-workflow-primitive, ins_no-decision-is-the-real-competitor, ins_sameness-perception-is-the-differentiation-barrier, ins_sales-team-detects-positioning-failure-first]
originating_operators: [april-dunford]
secondary_sources:
  - team-brain/workflows/competitive-analysis.md
  - flywheel/skills/competitive-displace/SKILL.md
  - flywheel/skills/competitive-scout/SKILL.md
---
...
3. Reframe the buying criteria. The criteria themselves are the real argument (`ins_sameness-perception-is-the-differentiation-barrier`).
